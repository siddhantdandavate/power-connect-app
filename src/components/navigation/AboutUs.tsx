  ...
  const features = [
    {
      ...
      description: 'Providing uninterrupted power supply to millions of customers across Maharashtra'
    },
    {
      icon: Users,
        ...
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className="text-lg opacity-90">
              Revolutionizing utility management for Maharashtra State Electricity Distribution Co. Ltd. (MSEDCL)
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            To provide reliable, efficient, and sustainable electricity distribution services to the people of Maharashtra 
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            ...
            and sustainable energy solutions that power the growth of Maharashtra.
          </p>
        </CardContent>
      </Card>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
                  <IconComponent className="text-blue-600 mt-1" size={24} />
                  <div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Prakashgad, Plot No. G-9, Bandra (E), Mumbai - 400051, Maharashtra
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">support@mahadiscom.in</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-center">
            ...
            <div>
              <p className="text-2xl font-bold text-orange-600">50M+</p>
      ...
      <Card className="text-center">
        <CardContent className="p-6">
          <p className="text-sm text-muted-foreground mb-4">
            PowerSync v1.0.0 | © 2024 MSEDCL | Made with ❤️ for better utility management
          </p>
